...
This is the current confirmed taxonomy membership - Part I frameworks, then Part II associated models. Not a narrative sequence; each entry stands on its own. New entries land here only after clearing the qualification test documented in the canonical spec.
...
- [The Access Was Real. The Authorization Wasn't.](https://www.rack2cloud.com/access-authorization-gap/) - Self-attestation as a purpose-verification control produces a logged answer without independently establishing the fact it exists to verify - the standard entitlement review can't catch it because it's structurally asking a different question. Included as a confirmed Part II model - no framework registry residency, qualification test passed on direct evidence review against the post's mechanism
...
- [Cloud Governance Failure Domains: When Governance Becomes Infrastructure](https://www.rack2cloud.com/cloud-governance-failure-domains/) - Adjacent governance-cost territory to Governance Theater's failure state - not itself a confirmed taxonomy member

**\>\_ SECTION 03: ARCHITECTURE, TOOLS & DECISION FRAMEWORKS**

Pillar pages, learning paths, the framework registry, and the canonical specification this playbook draws from.

**Canonical Specification**

- [Hidden Cost Models - Canonical Taxonomy (GitHub)](https://github.com/rack2cloud/hidden-cost-models) - The qualification test, common false positives, and the full Part I / Part II registry residency structure this playbook is built against. The authoritative source for taxonomy membership - this playbook reflects it, not the reverse

**Architecture References**

- [AI Infrastructure Architecture - Pillar Hub](https://www.rack2cloud.com/ai-infrastructure-strategy-guide/)
- [Cloud Strategy - Pillar Hub](https://www.rack2cloud.com/cloud-strategy/)
- [AI Architecture Learning Path - Governance & Runtime Control (A6)](https://www.rack2cloud.com/ai-architecture-learning-path/governance-runtime-control/)
- [Cloud Architecture Learning Path - Strategic Governance (CS6)](https://www.rack2cloud.com/cloud-architecture-learning-path/governance-architecture/)
- [Framework Registry Index](https://www.rack2cloud.com/frameworks/) - Full registry context for every framework named in Part I above

**Tools - Engineering Workbench**

- [Cloud Repatriation Economics Engine](https://www.rack2cloud.com/cloud-repatriation-cost-model/) - Model dependency-concentration exposure before a repatriation decision locks it in
- [Kubernetes Cost Density Calculator](https://www.rack2cloud.com/kubernetes-cost-density-calculator/) - Surface cost density that standard capacity review doesn't isolate
- [AI Runtime & Governance Analyzer](https://www.rack2cloud.com/ai-runtime-governance-analyzer/) - Evaluate whether governance structures can actually be exercised, not just documented - the operational test behind Governance Theater
...
[Rack2Cloud](https://www.rack2cloud.com/) A hidden cost is not an expense you missed. It's a cost architecture created before anyone was in a position to see it.
